...
dump_all_words_encodings = False # If this is True, you get everything, otherwise, only the presentation of 1-10
...
class NeuralNetwork:
    def __init__(self, name, layers, type, outputs):
        ...
        for i in range(1, len(layers) - 1):
            # ??? There is NO +1's in the next few lines in add.py ????
